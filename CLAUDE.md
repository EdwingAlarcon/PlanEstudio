...
app-elearning/           # Next.js 15 interactive app (THE primary surface)
  content/               # Authoritative module/lab content for the app (migrated 2026-06-25) — edit HERE, not docs/
    ...
    labs/
      lab-02-*.md, lab-03-*.md, …       # one file per lab, same frontmatter pattern (52 total; includes labs 45/51/52/53/54/55/56/57 for ia, 61-67 for capstones/D365 depth, 71-80 for job-ready simulations, 91-92 for CRM Developer job-ready extensibility/troubleshooting)
