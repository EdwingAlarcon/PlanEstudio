...
| Customer Insights - Data/Journeys | CE Consultant / Data Specialist | Avanzado | Cubierto | Módulos 58, 63 | LAB-084, LAB-085, LAB-067 | Customer 360 + real-time journey con consentimiento | ¿Diferencia entre Customer Insights Data y Journeys? | Mantener como ruta específica Customer Insights | Alta |
| Field Service | CE Consultant | Avanzado | Cubierto | Módulo 59 | LAB-086, LAB-087, LAB-059 | Work order end-to-end, agreement, mobile offline y scheduling | ¿Qué elementos mínimos necesita una orden de trabajo? | Mantener como ruta específica Field Service | Alta |
...
| RPA-1 | Power Automate Desktop & RPA Professional Track | Implementado como Nivel RPA 67-76, LAB-104 a LAB-112, 3 challenges, 8 incident labs, 1 simulación profesional y recursos de portafolio/tenant. |
