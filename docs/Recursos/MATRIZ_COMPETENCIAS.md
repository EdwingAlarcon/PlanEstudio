...
Las filas marcadas **(nuevo)** identifican competencias sin laboratorio o capstone dedicado
todavía — son el backlog de contenido práctico pendiente, no una promesa ya cumplida.
...
| Buenas prácticas low-code (nomenclatura, sin hardcode) | Fundacional | Revisión de fórmulas vs. checklist de estilo | Capstone Maker **(nuevo)** | 0 fórmulas con valores hardcodeados que deberían ser variables/Named Formulas |
...
| Competencia | Nivel | Evidencia esperada | Lab / proyecto | Criterio de aprobación |
|---|---|---|---|---|
| Levantamiento de requerimientos / workshops | Intermedio | Acta de workshop con decisiones y pendientes | Capstone Consultor Funcional **(nuevo)** | Acta identifica ≥5 requerimientos con dueño y prioridad |
| Historias de usuario y criterios de aceptación | Intermedio | Backlog "Como... quiero... para..." + Given/When/Then | Capstone Consultor Funcional **(nuevo)** | ≥8 historias, criterios verificables (no ambiguos) |
...
| Capacitación a usuarios finales | Intermedio | Manual de usuario + agenda de sesión de capacitación | Capstone Consultor Funcional **(nuevo)** | Manual cubre los 3 flujos más usados sin jerga técnica |
...
| PCF Controls | Avanzado | Control empaquetado + captura funcionando en formulario | Capstone Developer **(nuevo)** | Maneja al menos un estado de error de forma visible |
...
| Dual-write conceptual | Conceptual | Diagrama de entidades sincronizadas + dirección del flujo | Capstone F&O Awareness **(nuevo)** | Identifica qué entidad es "fuente de verdad" en cada dirección |
| Data Management Framework conceptual | Conceptual | Explicación de un escenario de importación masiva con manejo de errores | Capstone F&O Awareness **(nuevo)** | Propone estrategia de reintentos y validación previa a carga |
| Mapa de integración ERP + CRM | Conceptual-Avanzado | Diagrama de arquitectura con puntos de fallo señalados | Capstone F&O Awareness **(nuevo)** | Señala ≥2 puntos de fallo y su mitigación |
...
| Seguridad y gobernanza de agentes | Avanzado | Matriz de riesgos de IA (alucinación, fuga de datos, sobre-confianza) | Capstone AI & Copilot **(nuevo)** | ≥4 riesgos identificados con mitigación concreta, no genérica |
...
## Qué falta para que esta matriz esté 100% respaldada por contenido

Las filas marcadas **(nuevo)** dependen de capstones que todavía no existen como laboratorio
propio (Maker, Consultor Funcional, Developer, F&O Awareness, AI & Copilot). El proyecto
integrador de Dynamics 365 CE y el capstone de arquitectura ya existen — ver [Lab
60](../../app-elearning/content/labs/lab-60-proyecto-integrador-servicio-postventa.md) y el
Módulo 41 — y ya están enlazados desde las rutas `dynamics-365-customer-engagement` y
`solution-architect`.
