...
import {
  ...
  Layers3, Building2, Workflow, Bot, Compass, GitBranch, Wrench, BrainCircuit, Brain,
} from "lucide-react";
...
const RESOURCE_LINKS = [
  ...
  { href: "/recursos/guia-repaso-inteligente", label: UI.nav.reviewGuide, icon: Brain },
];
    ...
    <>
      ...
      >
        ...
        <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden px-2 py-3">
          ...
          <NavLink href="/repaso" icon={Brain} label={UI.nav.review} active={pathname === "/repaso"} />
