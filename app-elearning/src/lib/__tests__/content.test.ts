...
describe("getAllResourcePages", () => {
  it("returns 32 resource pages (incluye recursos RPA, portabilidad, guías de herramientas, prácticas interactivas, repaso espaciado y las guías de ruta cero/fundamentos CRM/Dataverse/tipos de práctica; no incluye 'simulador', que quedó retirado del mapeo de la app Next.js por ser un stub sin equivalente funcional — el simulador real vive en /simulador)", () => {
