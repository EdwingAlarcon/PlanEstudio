...
describe("getAllResourcePages", () => {
  it("returns 31 resource pages (incluye recursos RPA, portabilidad, guías de herramientas, prácticas interactivas, repaso espaciado y los puentes de ruta cero/fundamentos CRM/tipos de práctica; no incluye 'simulador', que quedó retirado del mapeo de la app Next.js por ser un stub sin equivalente funcional — el simulador real vive en /simulador)", () => {
