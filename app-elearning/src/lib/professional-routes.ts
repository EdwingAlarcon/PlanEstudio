...
const PROFESSIONAL_ROUTES: ProfessionalRoute[] = [
  ...
  },
  {
    ...
    labs: [
      ...
      "lab-86-field-service-agreement-preventive-maintenance",
      "lab-87-field-service-mobile-offline-work-order",
      "lab-113-field-service-capstone-operacion-de-campo",
      "lab-90-capstone-enterprise-d365",
    ],
    ...
    capstoneLabSlug: "lab-113-field-service-capstone-operacion-de-campo",
    portfolioEvidence: [
      ...
      "Capstone integrador de operación de campo (LAB-113) con decision log conectado a los Labs 86 y 87",
    ],
    nextRouteSlug: "dynamics-365-customer-engagement",
  },
  {
