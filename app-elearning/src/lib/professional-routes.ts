...
const PROFESSIONAL_ROUTES: ProfessionalRoute[] = [
  ...
  },
  {
    ...
    gapNote: "La ruta cubre F&O awareness avanzado, process mapping, matriz de ownership y diseño CE + F&O. Sigue sin reemplazar una especialización profunda de configuración Finance/SCM/Commerce/Project Operations; para eso se requiere ambiente F&O real y formación dedicada por producto.",
    capstoneLabSlug: "lab-90-capstone-enterprise-d365",
    portfolioEvidence: [
