...
const PROFESSIONAL_ROUTES: ProfessionalRoute[] = [
  ...
  },
  {
    ...
    level: "Especialización",
    accent: "#8661C5",
    modules: [1, 18, 24, 31, 34, 35, 36, 38, 39, 41, 53, 59],
    labs: [
      "lab-19-cicd-azure-devops",
      "lab-54-conectar-app-externa-dataverse",
      "lab-56-cambiar-entornos-dev-test-prod",
    ...
    competencies: ["ERP vs CRM", "Procesos ERP estándar", "Dual-write conceptual", "Virtual tables", "Data Management", "Gobernanza"],
    status: "Especialización en construcción",
    gapNote: "El Módulo 59 ya cubre el vocabulario de procesos ERP estándar (order-to-cash, procure-to-pay, record-to-report, inventory-to-deliver) y el criterio de decisión dual-write/DMF/virtual tables — esta ruta ya no depende solo de conceptos genéricos de arquitectura. Todavía no reemplaza una ruta profunda de configuración real de producto (Finance, Supply Chain Management, Commerce, Project Operations).",
