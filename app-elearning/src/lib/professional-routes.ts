...
const PROFESSIONAL_ROUTES: ProfessionalRoute[] = [
  ...
  },
  {
    ...
    competencies: ["ERP vs CRM", "Procesos ERP estándar", "Mapeo de procesos O2C/P2P/R2R/I2D", "Dual-write técnico", "Virtual tables", "Data Management", "Gobernanza", "Configuración Finance/SCM/Project Operations (trial tenant)"],
    status: "Avanzado — especializaciones en expansión",
    gapNote: "La ruta cubre F&O awareness avanzado, process mapping, matriz de ownership, diseño CE + F&O y —desde LAB-093 a LAB-097— configuración hands-on de Finance, Procure-to-Pay, Order-to-Cash, inventario/producto y Project Operations en un trial tenant. Esos 5 labs no fueron verificados contra un tenant en vivo al momento de escribirse (ver nota de verificación en cada uno). Sigue faltando Commerce, seguridad F&O (duty/privilege), LCS y reporting con la misma profundidad práctica.",
    capstoneLabSlug: "lab-90-capstone-enterprise-d365",
    portfolioEvidence: [
