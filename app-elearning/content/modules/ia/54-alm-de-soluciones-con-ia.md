...
7. Compara tu diseño contra el ejemplo completo y ejecutable en `docs/Anexos/EJEMPLO_PIPELINE_POWER_PLATFORM_ALM.md` — identifica qué diferencias tiene con lo que tú diseñaste y por qué el job de import hacia producción usa `workflow_dispatch` en vez de dispararse automáticamente.
