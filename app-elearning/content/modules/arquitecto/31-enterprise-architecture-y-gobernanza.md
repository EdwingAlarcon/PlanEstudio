...
- **Nota de vigencia — CoE Starter Kit:** Microsoft dejó de mantener activamente el CoE Starter Kit; sus capacidades centrales de visibilidad y gobernanza ya están integradas en el **Power Platform admin center** y en **Managed Environments**, que hoy son el punto de partida recomendado (ver Módulo 32 para el detalle completo).
