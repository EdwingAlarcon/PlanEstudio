...
### 📖 Conceptos Clave
- **Contact Center vs. Customer Service:** Customer Service administra casos y conocimiento (el "qué" del problema); Contact Center/Omnichannel agrega canales, conversaciones, presencia, distribución de trabajo en tiempo real y experiencia de agente (el "cómo" se atiende en vivo). Un proyecto puede tener Customer Service sin Contact Center (soporte por email/portal), pero no al revés en el modo **embedded** — ahí Contact Center necesita casos y conocimiento detrás de cada conversación (el escenario principal que describe este módulo y el Lab 83 asociado). Microsoft también ofrece un modo **standalone**: un contact center AI-first que funciona con cualquier CRM, incluso no-Microsoft, sin depender de casos ni conocimiento de Dataverse detrás.
